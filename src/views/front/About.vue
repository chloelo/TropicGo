<template>
  <div class="front front-about">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            >
              ...
              <p>
                TropicGo 正是這樣的存在，因為我們什麼沒有，最多的就是熱情了，
                當你沒有了動力往前，想要休息充電，想要讓自己沉澱，就來這裡逛逛吧，或多或少都會讓你感染一些我們想要帶給您如陽光般和煦的溫暖。
              </p>
            </div>
          </div>
        </div>
    ...
    <section class="zones zone_crew">
      <div class="container">
        <h2 class="mb-5 title-dec">
          <span class="circle" /><span class="txt text-primary">TropicGo 成員</span>
        </h2>
        <div class="row h-100">
